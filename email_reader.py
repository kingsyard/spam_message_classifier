...
link_data1=[]
link_data2=[]
from good_bad_link_classification  import  list_link_tag
                        ...
                        if part.get_content_type()=="text/plain" or part.get_content_type()=="text/html":
                            ...
                            if  type_of_message=="spam":
                                try:
                                          ...
                                          links,spam_ham=list_link_tag(message.decode())
                                          ...
                                          #  link_data1 = links
                                           # link_data2=spam_ham
                                           link_data="Message have links"

                                           
                                            

                                          else:
                                            link_data="Message have no links"


                                          messages_recieved_by_sequence_spam.append(message.decode()+str("links Data")+str(links)+str(spam_ham))
                                          
                                except:


                                    messages_recieved_by_sequence_spam.append(message.decode()+str("links Data")+str("No Proper Links in Message"))
                                ...
                                try:
                                        ...
                                        #  messages_recieved_by_sequence_spam.append(message.decode()+str("links Data")+str(link_data))
                                          

                                          messages_recieved_by_sequence_ham.append(message.decode()+str("links Data")+str(links)+str(spam_ham))

                                except:
                                          messages_recieved_by_sequence_ham.append(message.decode()+str("links Data")+str("No Proper Links in Message"))                                  
